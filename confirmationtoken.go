...
type ConfirmationTokenPaymentMethodOptionsCardInstallments struct {
	Plan *ConfirmationTokenPaymentMethodOptionsCardInstallmentsPlan `json:"plan,omitempty"`
}
...
type ConfirmationTokenPaymentMethodOptionsCard struct {
	...
	// Installment configuration for payments.
	Installments *ConfirmationTokenPaymentMethodOptionsCardInstallments `json:"installments,omitempty"`
}
...
type ConfirmationTokenPaymentMethodPreviewCardGeneratedFromPaymentMethodDetailsCardPresentReceipt struct {
	// The type of account being debited or credited
	AccountType ConfirmationTokenPaymentMethodPreviewCardGeneratedFromPaymentMethodDetailsCardPresentReceiptAccountType `json:"account_type,omitempty"`
...
type ConfirmationTokenPaymentMethodPreviewCardGeneratedFromPaymentMethodDetails struct {
	CardPresent *ConfirmationTokenPaymentMethodPreviewCardGeneratedFromPaymentMethodDetailsCardPresent `json:"card_present,omitempty"`
...
type ConfirmationTokenPaymentMethodPreviewCardWallet struct {
	AmexExpressCheckout *ConfirmationTokenPaymentMethodPreviewCardWalletAmexExpressCheckout `json:"amex_express_checkout,omitempty"`
	ApplePay            *ConfirmationTokenPaymentMethodPreviewCardWalletApplePay            `json:"apple_pay,omitempty"`
	// (For tokenized numbers only.) The last four digits of the device account number.
	DynamicLast4 string                                                     `json:"dynamic_last4"`
	GooglePay    *ConfirmationTokenPaymentMethodPreviewCardWalletGooglePay  `json:"google_pay,omitempty"`
	Link         *ConfirmationTokenPaymentMethodPreviewCardWalletLink       `json:"link,omitempty"`
	Masterpass   *ConfirmationTokenPaymentMethodPreviewCardWalletMasterpass `json:"masterpass,omitempty"`
	SamsungPay   *ConfirmationTokenPaymentMethodPreviewCardWalletSamsungPay `json:"samsung_pay,omitempty"`
	// The type of the card wallet, one of `amex_express_checkout`, `apple_pay`, `google_pay`, `masterpass`, `samsung_pay`, `visa_checkout`, or `link`. An additional hash is included on the Wallet subhash with a name matching this value. It contains additional information specific to the card wallet type.
	Type         ConfirmationTokenPaymentMethodPreviewCardWalletType          `json:"type"`
	VisaCheckout *ConfirmationTokenPaymentMethodPreviewCardWalletVisaCheckout `json:"visa_checkout,omitempty"`
}
...
type ConfirmationTokenPaymentMethodPreviewKlarna struct {
	// The customer's date of birth, if provided.
	DOB *ConfirmationTokenPaymentMethodPreviewKlarnaDOB `json:"dob,omitempty"`
}
...
type ConfirmationTokenPaymentMethodPreviewUSBankAccountStatusDetails struct {
	Blocked *ConfirmationTokenPaymentMethodPreviewUSBankAccountStatusDetailsBlocked `json:"blocked,omitempty"`
}
...
type ConfirmationTokenPaymentMethodPreview struct {
	ACSSDebit        *ConfirmationTokenPaymentMethodPreviewACSSDebit        `json:"acss_debit,omitempty"`
	Affirm           *ConfirmationTokenPaymentMethodPreviewAffirm           `json:"affirm,omitempty"`
	AfterpayClearpay *ConfirmationTokenPaymentMethodPreviewAfterpayClearpay `json:"afterpay_clearpay,omitempty"`
	Alipay           *ConfirmationTokenPaymentMethodPreviewAlipay           `json:"alipay,omitempty"`
	// This field indicates whether this payment method can be shown again to its customer in a checkout flow. Stripe products such as Checkout and Elements use this field to determine whether a payment method can be shown as a saved payment method in a checkout flow. The field defaults to “unspecified”.
	AllowRedisplay ConfirmationTokenPaymentMethodPreviewAllowRedisplay  `json:"allow_redisplay,omitempty"`
	Alma           *ConfirmationTokenPaymentMethodPreviewAlma           `json:"alma,omitempty"`
	AmazonPay      *ConfirmationTokenPaymentMethodPreviewAmazonPay      `json:"amazon_pay,omitempty"`
	AUBECSDebit    *ConfirmationTokenPaymentMethodPreviewAUBECSDebit    `json:"au_becs_debit,omitempty"`
	BACSDebit      *ConfirmationTokenPaymentMethodPreviewBACSDebit      `json:"bacs_debit,omitempty"`
	...
	IDEAL           *ConfirmationTokenPaymentMethodPreviewIDEAL           `json:"ideal,omitempty"`
	InteracPresent  *ConfirmationTokenPaymentMethodPreviewInteracPresent  `json:"interac_present,omitempty"`
	KakaoPay        *ConfirmationTokenPaymentMethodPreviewKakaoPay        `json:"kakao_pay,omitempty"`
	Klarna          *ConfirmationTokenPaymentMethodPreviewKlarna          `json:"klarna,omitempty"`
	Konbini         *ConfirmationTokenPaymentMethodPreviewKonbini         `json:"konbini,omitempty"`
	KrCard          *ConfirmationTokenPaymentMethodPreviewKrCard          `json:"kr_card,omitempty"`
	Link            *ConfirmationTokenPaymentMethodPreviewLink            `json:"link,omitempty"`
	MbWay           *ConfirmationTokenPaymentMethodPreviewMbWay           `json:"mb_way,omitempty"`
	Mobilepay       *ConfirmationTokenPaymentMethodPreviewMobilepay       `json:"mobilepay,omitempty"`
	Multibanco      *ConfirmationTokenPaymentMethodPreviewMultibanco      `json:"multibanco,omitempty"`
	NaverPay        *ConfirmationTokenPaymentMethodPreviewNaverPay        `json:"naver_pay,omitempty"`
	NzBankAccount   *ConfirmationTokenPaymentMethodPreviewNzBankAccount   `json:"nz_bank_account,omitempty"`
	OXXO            *ConfirmationTokenPaymentMethodPreviewOXXO            `json:"oxxo,omitempty"`
	P24             *ConfirmationTokenPaymentMethodPreviewP24             `json:"p24,omitempty"`
	PayByBank       *ConfirmationTokenPaymentMethodPreviewPayByBank       `json:"pay_by_bank,omitempty"`
