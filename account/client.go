...
func (c Client) Get() (*stripe.Account, error) { _ = "STUB: not implemented"; return nil, nil }
...
func List(params *stripe.AccountListParams) *Iter { _ = "STUB: not implemented"; return nil }
...
func (i *Iter) Account() *stripe.Account { _ = "STUB: not implemented"; return nil }

// AccountList returns the current list object which the iterator is
// currently using. List objects will change as new API calls are made to
// continue pagination.
func (i *Iter) AccountList() *stripe.AccountList { _ = "STUB: not implemented"; return nil }
