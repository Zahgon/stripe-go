...
type DisputeEvidenceEnhancedEvidenceVisaCompellingEvidence3DisputedTransactionParams struct {
	...
	CustomerAccountID *string `form:"customer_account_id" json:"customer_account_id,omitempty"`
	// Unique identifier of the cardholder's device derived from a combination of at least two hardware and software attributes. Must be at least 20 characters.
	CustomerDeviceFingerprint *string `form:"customer_device_fingerprint" json:"customer_device_fingerprint,omitempty"`
	// Unique identifier of the cardholder's device such as a device serial number (e.g., International Mobile Equipment Identity [IMEI]). Must be at least 15 characters.
	CustomerDeviceID *string `form:"customer_device_id" json:"customer_device_id,omitempty"`
	// The email address of the customer.
	CustomerEmailAddress *string `form:"customer_email_address" json:"customer_email_address,omitempty"`
	// The IP address that the customer used when making the purchase.
	CustomerPurchaseIP *string `form:"customer_purchase_ip" json:"customer_purchase_ip,omitempty"`
	// Categorization of disputed payment.
	MerchandiseOrServices *string `form:"merchandise_or_services" json:"merchandise_or_services,omitempty"`
	...
	UnsetFields     []DisputeEvidenceEnhancedEvidenceVisaCompellingEvidence3DisputedTransactionParamsUnsetField `form:"-" json:"-"`
}
...
type DisputeEvidenceEnhancedEvidenceVisaCompellingEvidence3PriorUndisputedTransactionParams struct {
	...
	// The address to which a physical product was shipped. All fields are required for Visa Compelling Evidence 3.0 evidence submission.
	ShippingAddress *AddressParams                                                                                     `form:"shipping_address" json:"shipping_address,omitempty"`
	UnsetFields     []DisputeEvidenceEnhancedEvidenceVisaCompellingEvidence3PriorUndisputedTransactionParamsUnsetField `form:"-" json:"-"`
}
...
type DisputeEvidenceEnhancedEvidenceVisaCompellingEvidence3Params struct {
	// Disputed transaction details for Visa Compelling Evidence 3.0 evidence submission.
	DisputedTransaction *DisputeEvidenceEnhancedEvidenceVisaCompellingEvidence3DisputedTransactionParams `form:"disputed_transaction" json:"disputed_transaction,omitempty"`
	// List of exactly two prior undisputed transaction objects for Visa Compelling Evidence 3.0 evidence submission.
	PriorUndisputedTransactions []*DisputeEvidenceEnhancedEvidenceVisaCompellingEvidence3PriorUndisputedTransactionParams `form:"prior_undisputed_transactions" json:"prior_undisputed_transactions,omitempty"`
}
...
type DisputeEvidenceEnhancedEvidenceParams struct {
	...
	// Evidence provided for Visa compliance evidence submission.
	VisaCompliance *DisputeEvidenceEnhancedEvidenceVisaComplianceParams `form:"visa_compliance" json:"visa_compliance,omitempty"`
}
...
type DisputeEvidenceParams struct {
	...
	CancellationPolicy *string `form:"cancellation_policy" json:"cancellation_policy,omitempty"`
	// An explanation of how and when the customer was shown your refund policy prior to purchase. Has a maximum character count of 20,000.
	CancellationPolicyDisclosure *string `form:"cancellation_policy_disclosure" json:"cancellation_policy_disclosure,omitempty"`
	// A justification for why the customer's subscription was not canceled. Has a maximum character count of 20,000.
	CancellationRebuttal *string `form:"cancellation_rebuttal" json:"cancellation_rebuttal,omitempty"`
	// (ID of a [file upload](https://stripe.com/docs/guides/file-upload)) Any communication with the customer that you feel is relevant to your case. Examples include emails proving that the customer received the product or service, or demonstrating their use of or satisfaction with the product or service.
	CustomerCommunication *string `form:"customer_communication" json:"customer_communication,omitempty"`
	// The email address of the customer.
	CustomerEmailAddress *string `form:"customer_email_address" json:"customer_email_address,omitempty"`
	// The name of the customer.
	CustomerName *string `form:"customer_name" json:"customer_name,omitempty"`
	// The IP address that the customer used when making the purchase.
	CustomerPurchaseIP *string `form:"customer_purchase_ip" json:"customer_purchase_ip,omitempty"`
	// (ID of a [file upload](https://stripe.com/docs/guides/file-upload)) A relevant document or contract showing the customer's signature.
	CustomerSignature *string `form:"customer_signature" json:"customer_signature,omitempty"`
	// (ID of a [file upload](https://stripe.com/docs/guides/file-upload)) Documentation for the prior charge that can uniquely identify the charge, such as a receipt, shipping label, work order, etc. This document should be paired with a similar document from the disputed payment that proves the two payments are separate.
	DuplicateChargeDocumentation *string `form:"duplicate_charge_documentation" json:"duplicate_charge_documentation,omitempty"`
	...
	DuplicateChargeExplanation *string `form:"duplicate_charge_explanation" json:"duplicate_charge_explanation,omitempty"`
	// The Stripe ID for the prior charge which appears to be a duplicate of the disputed charge.
	DuplicateChargeID *string `form:"duplicate_charge_id" json:"duplicate_charge_id,omitempty"`
	// Additional evidence for qualifying evidence programs.
	EnhancedEvidence *DisputeEvidenceEnhancedEvidenceParams `form:"enhanced_evidence" json:"enhanced_evidence,omitempty"`
	// A description of the product or service that was sold. Has a maximum character count of 20,000.
	ProductDescription *string `form:"product_description" json:"product_description,omitempty"`
	// (ID of a [file upload](https://stripe.com/docs/guides/file-upload)) Any receipt or message sent to the customer notifying them of the charge.
	Receipt *string `form:"receipt" json:"receipt,omitempty"`
	// (ID of a [file upload](https://stripe.com/docs/guides/file-upload)) Your refund policy, as shown to the customer.
	RefundPolicy *string `form:"refund_policy" json:"refund_policy,omitempty"`
	...
	RefundPolicyDisclosure *string `form:"refund_policy_disclosure" json:"refund_policy_disclosure,omitempty"`
	// A justification for why the customer is not entitled to a refund. Has a maximum character count of 20,000.
	RefundRefusalExplanation *string `form:"refund_refusal_explanation" json:"refund_refusal_explanation,omitempty"`
	// The date on which the customer received or began receiving the purchased service, in a clear human-readable format.
	ServiceDate *string `form:"service_date" json:"service_date,omitempty"`
	// (ID of a [file upload](https://stripe.com/docs/guides/file-upload)) Documentation showing proof that a service was provided to the customer. This could include a copy of a signed contract, work order, or other form of written agreement.
	ServiceDocumentation *string `form:"service_documentation" json:"service_documentation,omitempty"`
	// The address to which a physical product was shipped. You should try to include as complete address information as possible.
	ShippingAddress *string `form:"shipping_address" json:"shipping_address,omitempty"`
	// The delivery service that shipped a physical product, such as Fedex, UPS, USPS, etc. If multiple carriers were used for this purchase, please separate them with commas.
	ShippingCarrier *string `form:"shipping_carrier" json:"shipping_carrier,omitempty"`
	// The date on which a physical product began its route to the shipping address, in a clear human-readable format.
	ShippingDate *string `form:"shipping_date" json:"shipping_date,omitempty"`
	// (ID of a [file upload](https://stripe.com/docs/guides/file-upload)) Documentation showing proof that a product was shipped to the customer at the same address the customer provided to you. This could include a copy of the shipment receipt, shipping label, etc. It should show the customer's full shipping address, if possible.
	ShippingDocumentation *string `form:"shipping_documentation" json:"shipping_documentation,omitempty"`
	// The tracking number for a physical product, obtained from the delivery service. If multiple tracking numbers were generated for this purchase, please separate them with commas.
	ShippingTrackingNumber *string `form:"shipping_tracking_number" json:"shipping_tracking_number,omitempty"`
	// (ID of a [file upload](https://stripe.com/docs/guides/file-upload)) Any additional evidence or statements.
	UncategorizedFile *string `form:"uncategorized_file" json:"uncategorized_file,omitempty"`
	// Any additional evidence or statements. Has a maximum character count of 20,000.
	UncategorizedText *string                           `form:"uncategorized_text" json:"uncategorized_text,omitempty"`
	UnsetFields       []DisputeEvidenceParamsUnsetField `form:"-" json:"-"`
}
...
type DisputeUpdateEvidenceEnhancedEvidenceVisaCompellingEvidence3DisputedTransactionParams struct {
	...
	// The address to which a physical product was shipped. All fields are required for Visa Compelling Evidence 3.0 evidence submission.
	ShippingAddress *AddressParams                                                                                    `form:"shipping_address" json:"shipping_address,omitempty"`
	UnsetFields     []DisputeUpdateEvidenceEnhancedEvidenceVisaCompellingEvidence3DisputedTransactionParamsUnsetField `form:"-" json:"-"`
}
...
type DisputeUpdateEvidenceEnhancedEvidenceVisaCompellingEvidence3PriorUndisputedTransactionParams struct {
	...
	// The address to which a physical product was shipped. All fields are required for Visa Compelling Evidence 3.0 evidence submission.
	ShippingAddress *AddressParams                                                                                           `form:"shipping_address" json:"shipping_address,omitempty"`
	UnsetFields     []DisputeUpdateEvidenceEnhancedEvidenceVisaCompellingEvidence3PriorUndisputedTransactionParamsUnsetField `form:"-" json:"-"`
}
...
type DisputeUpdateEvidenceEnhancedEvidenceVisaCompellingEvidence3Params struct {
	// Disputed transaction details for Visa Compelling Evidence 3.0 evidence submission.
	DisputedTransaction *DisputeUpdateEvidenceEnhancedEvidenceVisaCompellingEvidence3DisputedTransactionParams `form:"disputed_transaction" json:"disputed_transaction,omitempty"`
	// List of exactly two prior undisputed transaction objects for Visa Compelling Evidence 3.0 evidence submission.
	PriorUndisputedTransactions []*DisputeUpdateEvidenceEnhancedEvidenceVisaCompellingEvidence3PriorUndisputedTransactionParams `form:"prior_undisputed_transactions" json:"prior_undisputed_transactions,omitempty"`
}
...
type DisputeUpdateEvidenceEnhancedEvidenceParams struct {
	...
	// Evidence provided for Visa compliance evidence submission.
	VisaCompliance *DisputeUpdateEvidenceEnhancedEvidenceVisaComplianceParams `form:"visa_compliance" json:"visa_compliance,omitempty"`
}
...
type DisputeUpdateEvidenceParams struct {
	...
	DuplicateChargeID *string `form:"duplicate_charge_id" json:"duplicate_charge_id,omitempty"`
	// Additional evidence for qualifying evidence programs.
	EnhancedEvidence *DisputeUpdateEvidenceEnhancedEvidenceParams `form:"enhanced_evidence" json:"enhanced_evidence,omitempty"`
	// A description of the product or service that was sold. Has a maximum character count of 20,000.
	ProductDescription *string `form:"product_description" json:"product_description,omitempty"`
	// (ID of a [file upload](https://stripe.com/docs/guides/file-upload)) Any receipt or message sent to the customer notifying them of the charge.
	Receipt *string `form:"receipt" json:"receipt,omitempty"`
	...
	// Any additional evidence or statements. Has a maximum character count of 20,000.
	UncategorizedText *string                                 `form:"uncategorized_text" json:"uncategorized_text,omitempty"`
	UnsetFields       []DisputeUpdateEvidenceParamsUnsetField `form:"-" json:"-"`
}
...
type DisputeUpdateParams struct {
	Params `form:"*"`
	// Evidence to upload, to respond to a dispute. Updating any field in the hash will submit all fields in the hash for review. The combined character count of all fields is limited to 150,000.
	Evidence *DisputeUpdateEvidenceParams `form:"evidence" json:"evidence,omitempty"`
	// Specifies which fields in the response should be expanded.
	Expand []*string `form:"expand" json:"expand,omitempty"`
	// Set of [key-value pairs](https://docs.stripe.com/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to `metadata`.
	Metadata map[string]string `form:"metadata" json:"metadata,omitempty"`
...
type DisputePaymentMethodDetailsKlarna struct {
	...
	ChargebackLossReasonCode string `json:"chargeback_loss_reason_code,omitempty"`
...
type DisputePaymentMethodDetails struct {
	AmazonPay *DisputePaymentMethodDetailsAmazonPay `json:"amazon_pay,omitempty"`
	Card      *DisputePaymentMethodDetailsCard      `json:"card,omitempty"`
	Klarna    *DisputePaymentMethodDetailsKlarna    `json:"klarna,omitempty"`
	Paypal    *DisputePaymentMethodDetailsPaypal    `json:"paypal,omitempty"`
	// Payment method type.
...
type Dispute struct {
	...
	PaymentMethodDetails *DisputePaymentMethodDetails `json:"payment_method_details,omitempty"`
	// Reason given by cardholder for dispute. Possible values are `bank_cannot_process`, `check_returned`, `credit_not_processed`, `customer_initiated`, `debit_not_authorized`, `duplicate`, `fraudulent`, `general`, `incorrect_account_details`, `insufficient_funds`, `noncompliant`, `product_not_received`, `product_unacceptable`, `subscription_canceled`, or `unrecognized`. Learn more about [dispute reasons](https://docs.stripe.com/disputes/categories).
