...
func List(params *stripe.TaxRegistrationListParams) *Iter { _ = "STUB: not implemented"; return nil }
...
func (i *Iter) TaxRegistration() *stripe.TaxRegistration { _ = "STUB: not implemented"; return nil }
