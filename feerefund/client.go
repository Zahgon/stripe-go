...
func List(params *stripe.FeeRefundListParams) *Iter { _ = "STUB: not implemented"; return nil }
...
func (i *Iter) FeeRefund() *stripe.FeeRefund { _ = "STUB: not implemented"; return nil }

// FeeRefundList returns the current list object which the iterator is
// currently using. List objects will change as new API calls are made to
// continue pagination.
func (i *Iter) FeeRefundList() *stripe.FeeRefundList { _ = "STUB: not implemented"; return nil }
