...
type MandatePaymentMethodDetailsPix struct {
	// Determines if the amount includes the IOF tax.
	AmountIncludesIof MandatePaymentMethodDetailsPixAmountIncludesIof `json:"amount_includes_iof,omitempty"`
	// Type of amount.
	AmountType MandatePaymentMethodDetailsPixAmountType `json:"amount_type,omitempty"`
	// Date when the mandate expires and no further payments will be charged, in `YYYY-MM-DD`.
	EndDate string `json:"end_date,omitempty"`
	// Schedule at which the future payments will be charged.
	PaymentSchedule MandatePaymentMethodDetailsPixPaymentSchedule `json:"payment_schedule,omitempty"`
