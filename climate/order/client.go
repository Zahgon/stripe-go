...
func List(params *stripe.ClimateOrderListParams) *Iter { _ = "STUB: not implemented"; return nil }
...
func (i *Iter) ClimateOrder() *stripe.ClimateOrder { _ = "STUB: not implemented"; return nil }

// ClimateOrderList returns the current list object which the iterator is
// currently using. List objects will change as new API calls are made to
// continue pagination.
func (i *Iter) ClimateOrderList() *stripe.ClimateOrderList { _ = "STUB: not implemented"; return nil }
