...
const (
	...
	IssuingCardCancellationReasonFulfillmentError IssuingCardCancellationReason = "fulfillment_error"
...
const (
	...
	IssuingCardReplacementReasonFulfillmentError IssuingCardReplacementReason = "fulfillment_error"
...
type IssuingCardSpendingControlsAllowedCardPresence string

// List of values that IssuingCardSpendingControlsAllowedCardPresence can take
const (
	IssuingCardSpendingControlsAllowedCardPresenceNotPresent IssuingCardSpendingControlsAllowedCardPresence = "not_present"
	IssuingCardSpendingControlsAllowedCardPresencePresent    IssuingCardSpendingControlsAllowedCardPresence = "present"
)
...
type IssuingCardSpendingControlsBlockedCardPresence string

// List of values that IssuingCardSpendingControlsBlockedCardPresence can take
const (
	IssuingCardSpendingControlsBlockedCardPresenceNotPresent IssuingCardSpendingControlsBlockedCardPresence = "not_present"
	IssuingCardSpendingControlsBlockedCardPresencePresent    IssuingCardSpendingControlsBlockedCardPresence = "present"
)
...
type IssuingCardLifecycleControlsCancelAfterParams struct {
	...
	PaymentCount *int64 `form:"payment_count" json:"payment_count"`
}
...
type IssuingCardLifecycleControlsParams struct {
	// Cancels the card after the specified conditions are met.
	CancelAfter *IssuingCardLifecycleControlsCancelAfterParams `form:"cancel_after" json:"cancel_after"`
}

// The desired PIN for this card.
type IssuingCardPINParams struct {
	// The card's desired new PIN, encrypted under Stripe's public key.
	EncryptedNumber *string `form:"encrypted_number" json:"encrypted_number,omitempty"`
}
...
type IssuingCardShippingCustomsParams struct {
	...
	EORINumber *string `form:"eori_number" json:"eori_number,omitempty"`
}
...
type IssuingCardSpendingControlsParams struct {
	...
	// Limit spending with amount-based rules that apply across any cards this card replaced (i.e., its `replacement_for` card and _that_ card's `replacement_for` card, up the chain).
	SpendingLimits []*IssuingCardSpendingControlsSpendingLimitParams `form:"spending_limits" json:"spending_limits,omitempty"`
}
...
type IssuingCardParams struct {
	...
	// Rules that control the lifecycle of this card, such as automatic cancellation. Refer to our [documentation](https://docs.stripe.com/issuing/controls/lifecycle-controls) for more details.
	LifecycleControls *IssuingCardLifecycleControlsParams `form:"lifecycle_controls" json:"lifecycle_controls,omitempty"`
	...
	ReplacementReason *string `form:"replacement_reason" json:"replacement_reason,omitempty"`
	// The second line to print on the card. Max length: 24 characters.
	SecondLine *string `form:"second_line" json:"second_line,omitempty"`
	// The address where the card will be shipped.
	Shipping *IssuingCardShippingParams `form:"shipping" json:"shipping,omitempty"`
	// Rules that control spending for this card. Refer to our [documentation](https://docs.stripe.com/issuing/controls/spending-controls) for more details.
	SpendingControls *IssuingCardSpendingControlsParams `form:"spending_controls" json:"spending_controls,omitempty"`
...
type IssuingCardCreateLifecycleControlsParams struct {
	// Cancels the card after the specified conditions are met.
	CancelAfter *IssuingCardCreateLifecycleControlsCancelAfterParams `form:"cancel_after" json:"cancel_after"`
}
...
type IssuingCardCreateSpendingControlsParams struct {
	...
	BlockedMerchantCountries []*string `form:"blocked_merchant_countries" json:"blocked_merchant_countries,omitempty"`
	// Limit spending with amount-based rules that apply across any cards this card replaced (i.e., its `replacement_for` card and _that_ card's `replacement_for` card, up the chain).
	SpendingLimits []*IssuingCardCreateSpendingControlsSpendingLimitParams `form:"spending_limits" json:"spending_limits,omitempty"`
}
...
type IssuingCardCreateParams struct {
	...
	FinancialAccount *string `form:"financial_account" json:"financial_account,omitempty"`
	// Rules that control the lifecycle of this card, such as automatic cancellation. Refer to our [documentation](https://docs.stripe.com/issuing/controls/lifecycle-controls) for more details.
	LifecycleControls *IssuingCardCreateLifecycleControlsParams `form:"lifecycle_controls" json:"lifecycle_controls,omitempty"`
	// Set of [key-value pairs](https://docs.stripe.com/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to `metadata`.
	Metadata map[string]string `form:"metadata" json:"metadata,omitempty"`
	// The personalization design object belonging to this card.
	PersonalizationDesign *string `form:"personalization_design" json:"personalization_design,omitempty"`
	...
	SecondLine *string `form:"second_line" json:"second_line,omitempty"`
	// The address where the card will be shipped.
	Shipping *IssuingCardCreateShippingParams `form:"shipping" json:"shipping,omitempty"`
	// Rules that control spending for this card. Refer to our [documentation](https://docs.stripe.com/issuing/controls/spending-controls) for more details.
	SpendingControls *IssuingCardCreateSpendingControlsParams `form:"spending_controls" json:"spending_controls,omitempty"`
	// Whether authorizations can be approved on this card. May be blocked from activating cards depending on past-due Cardholder requirements. Defaults to `inactive`.
	Status *string `form:"status" json:"status,omitempty"`
	// The type of card to issue. Possible values are `physical` or `virtual`.
...
type IssuingCardUpdateSpendingControlsParams struct {
	...
	BlockedMerchantCountries []*string `form:"blocked_merchant_countries" json:"blocked_merchant_countries,omitempty"`
	// Limit spending with amount-based rules that apply across any cards this card replaced (i.e., its `replacement_for` card and _that_ card's `replacement_for` card, up the chain).
	SpendingLimits []*IssuingCardUpdateSpendingControlsSpendingLimitParams `form:"spending_limits" json:"spending_limits,omitempty"`
}
...
type IssuingCardUpdateParams struct {
	...
	// Rules that control spending for this card. Refer to our [documentation](https://docs.stripe.com/issuing/controls/spending-controls) for more details.
	SpendingControls *IssuingCardUpdateSpendingControlsParams `form:"spending_controls" json:"spending_controls,omitempty"`
	// Dictates whether authorizations can be approved on this card. May be blocked from activating cards depending on past-due Cardholder requirements. Defaults to `inactive`. If this card is being canceled because it was lost or stolen, this information should be provided as `cancellation_reason`.
	Status      *string                             `form:"status" json:"status,omitempty"`
...
type IssuingCardSpendingControls struct {
	// Array of card presence statuses from which authorizations will be allowed. Possible options are `present`, `not_present`. All other statuses will be blocked. Cannot be set with `blocked_card_presences`. Provide an empty value to unset this control.
	AllowedCardPresences []IssuingCardSpendingControlsAllowedCardPresence `json:"allowed_card_presences"`
	// Array of strings containing [categories](https://docs.stripe.com/api#issuing_authorization_object-merchant_data-category) of authorizations to allow. All other categories will be blocked. Cannot be set with `blocked_categories`.
	AllowedCategories []string `json:"allowed_categories"`
	// Array of strings containing representing countries from which authorizations will be allowed. Authorizations from merchants in all other countries will be declined. Country codes should be ISO 3166 alpha-2 country codes (e.g. `US`). Cannot be set with `blocked_merchant_countries`. Provide an empty value to unset this control.
	AllowedMerchantCountries []string `json:"allowed_merchant_countries"`
	// Array of card presence statuses from which authorizations will be declined. Possible options are `present`, `not_present`. Cannot be set with `allowed_card_presences`. Provide an empty value to unset this control.
	BlockedCardPresences []IssuingCardSpendingControlsBlockedCardPresence `json:"blocked_card_presences"`
	// Array of strings containing [categories](https://docs.stripe.com/api#issuing_authorization_object-merchant_data-category) of authorizations to decline. All other categories will be allowed. Cannot be set with `allowed_categories`.
