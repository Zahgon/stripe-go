...
func NewClient(key string, opts ...ClientOption) *Client { _ = "STUB: not implemented"; return nil }

func initClient(client *Client, cfg clientConfig) { _ = "STUB: not implemented"; return }
