...
import (
	...
	"github.com/stripe/stripe-go/v85/accountsession"
	"github.com/stripe/stripe-go/v85/applepaydomain"
	"github.com/stripe/stripe-go/v85/applicationfee"
	appssecret "github.com/stripe/stripe-go/v85/apps/secret"
	"github.com/stripe/stripe-go/v85/balance"
	"github.com/stripe/stripe-go/v85/balancesettings"
	"github.com/stripe/stripe-go/v85/balancetransaction"
	"github.com/stripe/stripe-go/v85/bankaccount"
	billingalert "github.com/stripe/stripe-go/v85/billing/alert"
	billingcreditbalancesummary "github.com/stripe/stripe-go/v85/billing/creditbalancesummary"
	billingcreditbalancetransaction "github.com/stripe/stripe-go/v85/billing/creditbalancetransaction"
	billingcreditgrant "github.com/stripe/stripe-go/v85/billing/creditgrant"
	billingmeter "github.com/stripe/stripe-go/v85/billing/meter"
	billingmeterevent "github.com/stripe/stripe-go/v85/billing/meterevent"
	billingmetereventadjustment "github.com/stripe/stripe-go/v85/billing/metereventadjustment"
	billingmetereventsummary "github.com/stripe/stripe-go/v85/billing/metereventsummary"
	billingportalconfiguration "github.com/stripe/stripe-go/v85/billingportal/configuration"
	billingportalsession "github.com/stripe/stripe-go/v85/billingportal/session"
	"github.com/stripe/stripe-go/v85/capability"
	"github.com/stripe/stripe-go/v85/card"
	"github.com/stripe/stripe-go/v85/cashbalance"
	"github.com/stripe/stripe-go/v85/charge"
	checkoutsession "github.com/stripe/stripe-go/v85/checkout/session"
	climateorder "github.com/stripe/stripe-go/v85/climate/order"
	climateproduct "github.com/stripe/stripe-go/v85/climate/product"
	climatesupplier "github.com/stripe/stripe-go/v85/climate/supplier"
	"github.com/stripe/stripe-go/v85/confirmationtoken"
	"github.com/stripe/stripe-go/v85/countryspec"
	"github.com/stripe/stripe-go/v85/coupon"
	"github.com/stripe/stripe-go/v85/creditnote"
	...
	entitlementsfeature "github.com/stripe/stripe-go/v85/entitlements/feature"
	"github.com/stripe/stripe-go/v85/ephemeralkey"
	"github.com/stripe/stripe-go/v85/event"
	"github.com/stripe/stripe-go/v85/feerefund"
	"github.com/stripe/stripe-go/v85/file"
	"github.com/stripe/stripe-go/v85/filelink"
	financialconnectionsaccount "github.com/stripe/stripe-go/v85/financialconnections/account"
	financialconnectionssession "github.com/stripe/stripe-go/v85/financialconnections/session"
	financialconnectionstransaction "github.com/stripe/stripe-go/v85/financialconnections/transaction"
	...
	"github.com/stripe/stripe-go/v85/invoicelineitem"
	"github.com/stripe/stripe-go/v85/invoicepayment"
	"github.com/stripe/stripe-go/v85/invoicerenderingtemplate"
	issuingauthorization "github.com/stripe/stripe-go/v85/issuing/authorization"
	issuingcard "github.com/stripe/stripe-go/v85/issuing/card"
	issuingcardholder "github.com/stripe/stripe-go/v85/issuing/cardholder"
	issuingdispute "github.com/stripe/stripe-go/v85/issuing/dispute"
	issuingpersonalizationdesign "github.com/stripe/stripe-go/v85/issuing/personalizationdesign"
	issuingphysicalbundle "github.com/stripe/stripe-go/v85/issuing/physicalbundle"
	issuingtoken "github.com/stripe/stripe-go/v85/issuing/token"
	issuingtransaction "github.com/stripe/stripe-go/v85/issuing/transaction"
	"github.com/stripe/stripe-go/v85/loginlink"
	"github.com/stripe/stripe-go/v85/mandate"
	"github.com/stripe/stripe-go/v85/oauth"
	"github.com/stripe/stripe-go/v85/paymentattemptrecord"
	...
	"github.com/stripe/stripe-go/v85/paymentrecord"
	"github.com/stripe/stripe-go/v85/paymentsource"
	"github.com/stripe/stripe-go/v85/payout"
	"github.com/stripe/stripe-go/v85/person"
	"github.com/stripe/stripe-go/v85/plan"
	"github.com/stripe/stripe-go/v85/price"
	"github.com/stripe/stripe-go/v85/product"
	"github.com/stripe/stripe-go/v85/productfeature"
	"github.com/stripe/stripe-go/v85/promotioncode"
	"github.com/stripe/stripe-go/v85/quote"
	radarearlyfraudwarning "github.com/stripe/stripe-go/v85/radar/earlyfraudwarning"
	radarpaymentevaluation "github.com/stripe/stripe-go/v85/radar/paymentevaluation"
	radarvaluelist "github.com/stripe/stripe-go/v85/radar/valuelist"
	radarvaluelistitem "github.com/stripe/stripe-go/v85/radar/valuelistitem"
	"github.com/stripe/stripe-go/v85/refund"
	reportingreportrun "github.com/stripe/stripe-go/v85/reporting/reportrun"
	reportingreporttype "github.com/stripe/stripe-go/v85/reporting/reporttype"
	"github.com/stripe/stripe-go/v85/review"
	...
	"github.com/stripe/stripe-go/v85/sourcetransaction"
	...
	taxassociation "github.com/stripe/stripe-go/v85/tax/association"
	taxcalculation "github.com/stripe/stripe-go/v85/tax/calculation"
	taxregistration "github.com/stripe/stripe-go/v85/tax/registration"
	...
	terminalconnectiontoken "github.com/stripe/stripe-go/v85/terminal/connectiontoken"
	terminallocation "github.com/stripe/stripe-go/v85/terminal/location"
	terminalonboardinglink "github.com/stripe/stripe-go/v85/terminal/onboardinglink"
	terminalreader "github.com/stripe/stripe-go/v85/terminal/reader"
	testhelpersconfirmationtoken "github.com/stripe/stripe-go/v85/testhelpers/confirmationtoken"
	...
	testhelpersrefund "github.com/stripe/stripe-go/v85/testhelpers/refund"
	testhelpersterminalreader "github.com/stripe/stripe-go/v85/testhelpers/terminal/reader"
	testhelperstestclock "github.com/stripe/stripe-go/v85/testhelpers/testclock"
	testhelperstreasuryinboundtransfer "github.com/stripe/stripe-go/v85/testhelpers/treasury/inboundtransfer"
	testhelperstreasuryoutboundpayment "github.com/stripe/stripe-go/v85/testhelpers/treasury/outboundpayment"
	testhelperstreasuryoutboundtransfer "github.com/stripe/stripe-go/v85/testhelpers/treasury/outboundtransfer"
	testhelperstreasuryreceivedcredit "github.com/stripe/stripe-go/v85/testhelpers/treasury/receivedcredit"
	testhelperstreasuryreceiveddebit "github.com/stripe/stripe-go/v85/testhelpers/treasury/receiveddebit"
	"github.com/stripe/stripe-go/v85/token"
	"github.com/stripe/stripe-go/v85/topup"
	"github.com/stripe/stripe-go/v85/transfer"
	"github.com/stripe/stripe-go/v85/transferreversal"
	treasurycreditreversal "github.com/stripe/stripe-go/v85/treasury/creditreversal"
	treasurydebitreversal "github.com/stripe/stripe-go/v85/treasury/debitreversal"
	treasuryfinancialaccount "github.com/stripe/stripe-go/v85/treasury/financialaccount"
	treasuryinboundtransfer "github.com/stripe/stripe-go/v85/treasury/inboundtransfer"
	treasuryoutboundpayment "github.com/stripe/stripe-go/v85/treasury/outboundpayment"
	treasuryoutboundtransfer "github.com/stripe/stripe-go/v85/treasury/outboundtransfer"
	treasuryreceivedcredit "github.com/stripe/stripe-go/v85/treasury/receivedcredit"
	treasuryreceiveddebit "github.com/stripe/stripe-go/v85/treasury/receiveddebit"
	treasurytransaction "github.com/stripe/stripe-go/v85/treasury/transaction"
	treasurytransactionentry "github.com/stripe/stripe-go/v85/treasury/transactionentry"
	v2billingmeterevent "github.com/stripe/stripe-go/v85/v2/billing/meterevent"
	v2billingmetereventadjustment "github.com/stripe/stripe-go/v85/v2/billing/metereventadjustment"
	v2billingmetereventsession "github.com/stripe/stripe-go/v85/v2/billing/metereventsession"
	v2billingmetereventstream "github.com/stripe/stripe-go/v85/v2/billing/metereventstream"
	v2coreaccount "github.com/stripe/stripe-go/v85/v2/core/account"
	v2coreaccountlink "github.com/stripe/stripe-go/v85/v2/core/accountlink"
...
//
// [migration guide]: https://github.com/stripe/stripe-go/wiki/Migration-guide-for-Stripe-Client
func (a *API) Init(key string, backends *stripe.Backends) { _ = "STUB: not implemented"; return }
...
//
// [migration guide]: https://github.com/stripe/stripe-go/wiki/Migration-guide-for-Stripe-Client
func New(key string, backends *stripe.Backends) *API { _ = "STUB: not implemented"; return nil }
