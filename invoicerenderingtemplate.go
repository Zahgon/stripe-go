...
func (p *InvoiceRenderingTemplateListParams) AddExpand(f string) { _ = "STUB: not implemented"; return }
...
// AddExpand appends a new field to expand.
func (p *InvoiceRenderingTemplateParams) AddExpand(f string) { _ = "STUB: not implemented"; return }
