...
const (
	...
	EventTypeFinancialConnectionsAccountAccountNumbersUpdated       EventType = "financial_connections.account.account_numbers_updated"
	...
	EventTypeFinancialConnectionsAccountUpcomingAccountNumberExpiry EventType = "financial_connections.account.upcoming_account_number_expiry"
	...
	EventTypeInvoicePaymentPaid                                     EventType = "invoice_payment.paid"
	...
	EventTypeReserveHoldCreated                                     EventType = "reserve.hold.created"
	EventTypeReserveHoldUpdated                                     EventType = "reserve.hold.updated"
	EventTypeReservePlanCreated                                     EventType = "reserve.plan.created"
	EventTypeReservePlanDisabled                                    EventType = "reserve.plan.disabled"
	EventTypeReservePlanExpired                                     EventType = "reserve.plan.expired"
	EventTypeReservePlanUpdated                                     EventType = "reserve.plan.updated"
	EventTypeReserveReleaseCreated                                  EventType = "reserve.release.created"
