...
type TerminalReaderParams struct {
	...
	RegistrationCode *string                          `form:"registration_code" json:"registration_code,omitempty"`
	UnsetFields      []TerminalReaderParamsUnsetField `form:"-" json:"-"`
}

// TerminalReaderParamsUnsetField is the list of fields that can be cleared/unset on TerminalReaderParams.
type TerminalReaderParamsUnsetField string

const (
	TerminalReaderParamsUnsetFieldLabel    TerminalReaderParamsUnsetField = "label"
	TerminalReaderParamsUnsetFieldMetadata TerminalReaderParamsUnsetField = "metadata"
)
...
type TerminalReaderListParams struct {
	...
	DeviceType *string `form:"device_type" json:"device_type,omitempty"`
	// Specifies which fields in the response should be expanded.
	Expand []*string `form:"expand" json:"expand,omitempty"`
...
type TerminalReaderCollectInputsInputCustomTextParams struct {
	...
	SkipButton *string `form:"skip_button" json:"skip_button,omitempty"`
	// Custom text for the submit button. Maximum 30 characters.
	SubmitButton *string `form:"submit_button" json:"submit_button,omitempty"`
...
type TerminalReaderCollectInputsInputSelectionChoiceParams struct {
	...
	Style *string `form:"style" json:"style,omitempty"`
...
type TerminalReaderCollectInputsInputSelectionParams struct {
	// List of choices for the `selection` input
	Choices []*TerminalReaderCollectInputsInputSelectionChoiceParams `form:"choices" json:"choices"`
}
...
type TerminalReaderCollectInputsInputParams struct {
	// Customize the text which will be displayed while collecting this input
	CustomText *TerminalReaderCollectInputsInputCustomTextParams `form:"custom_text" json:"custom_text"`
	// Indicate that this input is required, disabling the skip button
	Required *bool `form:"required" json:"required,omitempty"`
	// Options for the `selection` input
	Selection *TerminalReaderCollectInputsInputSelectionParams `form:"selection" json:"selection,omitempty"`
	// List of toggles to be displayed and customization for the toggles
	Toggles []*TerminalReaderCollectInputsInputToggleParams `form:"toggles" json:"toggles,omitempty"`
...
type TerminalReaderCollectInputsParams struct {
	...
	Expand []*string `form:"expand" json:"expand,omitempty"`
	// List of inputs to be collected from the customer using the Reader. Maximum 5 inputs.
	Inputs []*TerminalReaderCollectInputsInputParams `form:"inputs" json:"inputs"`
	// Set of [key-value pairs](https://docs.stripe.com/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to `metadata`.
	Metadata map[string]string `form:"metadata" json:"metadata,omitempty"`
}
...
type TerminalReaderCollectPaymentMethodCollectConfigTippingParams struct {
	...
	AmountEligible *int64 `form:"amount_eligible" json:"amount_eligible,omitempty"`
}
...
type TerminalReaderCollectPaymentMethodCollectConfigParams struct {
	...
	// Tipping configuration for this transaction.
	Tipping *TerminalReaderCollectPaymentMethodCollectConfigTippingParams `form:"tipping" json:"tipping,omitempty"`
}
...
type TerminalReaderCollectPaymentMethodParams struct {
	Params `form:"*"`
	// Configuration overrides for this collection, such as tipping, surcharging, and customer cancellation settings.
	CollectConfig *TerminalReaderCollectPaymentMethodCollectConfigParams `form:"collect_config" json:"collect_config,omitempty"`
	// Specifies which fields in the response should be expanded.
	Expand []*string `form:"expand" json:"expand,omitempty"`
...
type TerminalReaderConfirmPaymentIntentParams struct {
	Params `form:"*"`
	// Configuration overrides for this confirmation, such as surcharge settings and return URL.
	ConfirmConfig *TerminalReaderConfirmPaymentIntentConfirmConfigParams `form:"confirm_config" json:"confirm_config,omitempty"`
	// Specifies which fields in the response should be expanded.
	Expand []*string `form:"expand" json:"expand,omitempty"`
...
type TerminalReaderProcessPaymentIntentProcessConfigParams struct {
	...
	SkipTipping *bool `form:"skip_tipping" json:"skip_tipping,omitempty"`
	// Tipping configuration for this transaction.
	Tipping *TerminalReaderProcessPaymentIntentProcessConfigTippingParams `form:"tipping" json:"tipping,omitempty"`
}
...
type TerminalReaderProcessPaymentIntentParams struct {
	...
	PaymentIntent *string `form:"payment_intent" json:"payment_intent"`
	// Configuration overrides for this transaction, such as tipping and customer cancellation settings.
	ProcessConfig *TerminalReaderProcessPaymentIntentProcessConfigParams `form:"process_config" json:"process_config,omitempty"`
}
...
type TerminalReaderProcessSetupIntentParams struct {
	Params `form:"*"`
	// This field indicates whether this payment method can be shown again to its customer in a checkout flow. Stripe products such as Checkout and Elements use this field to determine whether a payment method can be shown as a saved payment method in a checkout flow.
	AllowRedisplay *string `form:"allow_redisplay" json:"allow_redisplay"`
	// Specifies which fields in the response should be expanded.
	Expand []*string `form:"expand" json:"expand,omitempty"`
	// Configuration overrides for this setup, such as MOTO and customer cancellation settings.
	ProcessConfig *TerminalReaderProcessSetupIntentProcessConfigParams `form:"process_config" json:"process_config,omitempty"`
...
type TerminalReaderRefundPaymentParams struct {
	...
	// Configuration overrides for this refund, such as customer cancellation settings.
	RefundPaymentConfig *TerminalReaderRefundPaymentRefundPaymentConfigParams `form:"refund_payment_config" json:"refund_payment_config,omitempty"`
...
type TerminalReaderSetReaderDisplayCartParams struct {
	...
	// Array of line items to display.
	LineItems []*TerminalReaderSetReaderDisplayCartLineItemParams `form:"line_items" json:"line_items"`
	// The amount of tax in the [smallest currency unit](https://docs.stripe.com/currencies#zero-decimal).
	Tax *int64 `form:"tax" json:"tax,omitempty"`
...
type TerminalReaderSetReaderDisplayParams struct {
	Params `form:"*"`
	// Cart details to display on the reader screen, including line items, amounts, and currency.
	Cart *TerminalReaderSetReaderDisplayCartParams `form:"cart" json:"cart,omitempty"`
	// Specifies which fields in the response should be expanded.
	Expand []*string `form:"expand" json:"expand,omitempty"`
...
type TerminalReaderUpdateParams struct {
	...
	// Set of [key-value pairs](https://docs.stripe.com/api/metadata) that you can attach to an object. This can be useful for storing additional information about the object in a structured format. Individual keys can be unset by posting an empty value to them. All keys can be unset by posting an empty value to `metadata`.
	Metadata    map[string]string                      `form:"metadata" json:"metadata,omitempty"`
	UnsetFields []TerminalReaderUpdateParamsUnsetField `form:"-" json:"-"`
}

// TerminalReaderUpdateParamsUnsetField is the list of fields that can be cleared/unset on TerminalReaderUpdateParams.
type TerminalReaderUpdateParamsUnsetField string

const (
	TerminalReaderUpdateParamsUnsetFieldLabel    TerminalReaderUpdateParamsUnsetField = "label"
	TerminalReaderUpdateParamsUnsetFieldMetadata TerminalReaderUpdateParamsUnsetField = "metadata"
)
...
type TerminalReaderCreateParams struct {
	...
	UnsetFields      []TerminalReaderCreateParamsUnsetField `form:"-" json:"-"`
}

// TerminalReaderCreateParamsUnsetField is the list of fields that can be cleared/unset on TerminalReaderCreateParams.
type TerminalReaderCreateParamsUnsetField string

const (
	TerminalReaderCreateParamsUnsetFieldMetadata TerminalReaderCreateParamsUnsetField = "metadata"
)
...
type TerminalReaderActionCollectInputsInput struct {
	...
	// Information about a email being collected using a reader
	Email *TerminalReaderActionCollectInputsInputEmail `json:"email,omitempty"`
	// Information about a number being collected using a reader
	Numeric *TerminalReaderActionCollectInputsInputNumeric `json:"numeric,omitempty"`
	// Information about a phone number being collected using a reader
	Phone *TerminalReaderActionCollectInputsInputPhone `json:"phone,omitempty"`
	// Indicate that this input is required, disabling the skip button.
	Required bool `json:"required"`
	// Information about a selection being collected using a reader
	Selection *TerminalReaderActionCollectInputsInputSelection `json:"selection,omitempty"`
	// Information about a signature being collected using a reader
	Signature *TerminalReaderActionCollectInputsInputSignature `json:"signature,omitempty"`
	// Indicate that this input was skipped by the user.
	Skipped bool `json:"skipped,omitempty"`
	// Information about text being collected using a reader
	Text *TerminalReaderActionCollectInputsInputText `json:"text,omitempty"`
	// List of toggles being collected. Values are present if collection is complete.
...
type TerminalReaderActionCollectPaymentMethodCollectConfigTipping struct {
	// Amount used to calculate tip suggestions on tipping selection screen for this transaction. Must be a positive integer in the smallest currency unit (e.g., 100 cents to represent $1.00 or 100 to represent ¥100, a zero-decimal currency).
	AmountEligible int64 `json:"amount_eligible,omitempty"`
}

// Represents a per-transaction override of a reader configuration
type TerminalReaderActionCollectPaymentMethodCollectConfig struct {
	// Enable customer-initiated cancellation when processing this payment.
	EnableCustomerCancellation bool `json:"enable_customer_cancellation,omitempty"`
	// Override showing a tipping selection screen on this transaction.
	SkipTipping bool `json:"skip_tipping,omitempty"`
	// Represents a per-transaction tipping configuration
	Tipping *TerminalReaderActionCollectPaymentMethodCollectConfigTipping `json:"tipping,omitempty"`
}

// Represents a reader action to collect a payment method
type TerminalReaderActionCollectPaymentMethod struct {
	// Represents a per-transaction override of a reader configuration
	CollectConfig *TerminalReaderActionCollectPaymentMethodCollectConfig `json:"collect_config,omitempty"`
...
type TerminalReaderActionConfirmPaymentIntent struct {
	// Represents a per-transaction override of a reader configuration
	ConfirmConfig *TerminalReaderActionConfirmPaymentIntentConfirmConfig `json:"confirm_config,omitempty"`
	// Most recent PaymentIntent processed by the reader.
	PaymentIntent *PaymentIntent `json:"payment_intent"`
}
...
type TerminalReaderActionProcessPaymentIntentProcessConfig struct {
	...
	SkipTipping bool `json:"skip_tipping,omitempty"`
	// Represents a per-transaction tipping configuration
	Tipping *TerminalReaderActionProcessPaymentIntentProcessConfigTipping `json:"tipping,omitempty"`
}
...
type TerminalReaderActionProcessPaymentIntent struct {
	...
	PaymentIntent *PaymentIntent `json:"payment_intent"`
	// Represents a per-transaction override of a reader configuration
	ProcessConfig *TerminalReaderActionProcessPaymentIntentProcessConfig `json:"process_config,omitempty"`
}
...
type TerminalReaderActionProcessSetupIntent struct {
	...
	// Represents a per-setup override of a reader configuration
	ProcessConfig *TerminalReaderActionProcessSetupIntentProcessConfig `json:"process_config,omitempty"`
...
type TerminalReaderActionRefundPayment struct {
	...
	// The reason for the refund.
	Reason TerminalReaderActionRefundPaymentReason `json:"reason,omitempty"`
	// Unique identifier for the refund object.
	Refund *Refund `json:"refund,omitempty"`
	// Boolean indicating whether the application fee should be refunded when refunding this charge. If a full charge refund is given, the full application fee will be refunded. Otherwise, the application fee will be refunded in an amount proportional to the amount of the charge refunded. An application fee can be refunded only by the application that created the charge.
	RefundApplicationFee bool `json:"refund_application_fee,omitempty"`
	// Represents a per-transaction override of a reader configuration
	RefundPaymentConfig *TerminalReaderActionRefundPaymentRefundPaymentConfig `json:"refund_payment_config,omitempty"`
	// Boolean indicating whether the transfer should be reversed when refunding this charge. The transfer will be reversed proportionally to the amount being refunded (either the entire or partial amount). A transfer can be reversed only by the application that created the charge.
